...
// Check if SBO user is logged in
...
<head>
    ...
    <title>Scanner Settings - SBO Panel</title>
...
<body class="has-navbar">
    <?php renderNavigation('sbo', 'scanner', $_SESSION['sbo_name']); ?>
    
    <div class="container" style="margin-top: 2rem; margin-bottom: 2rem;">
        <!-- Header -->
        <div class="text-center" style="margin-bottom: 2rem;">
            <h1 style="color: #1e3a8a; margin-bottom: 0.5rem;">📱 Scanner Settings</h1>
            <p style="color: var(--gray-600); margin: 0;">
                Control QR scanner and manual ID entry availability for events
            </p>
        </div>
        ...
        <div class="settings-card">
            <div class="settings-header">
                ...
                <h3 style="margin: 0;">Scanner Controls</h3>
            </div>
            <div class="settings-content">
                ...
                <div class="setting-item">
                    <div class="setting-info">
                        ...
                        <p>Enable or disable camera-based QR code scanning for events</p>
                ...
                <div class="setting-item">
                    <div class="setting-info">
                        ...
                        <p>Enable or disable manual student ID input for attendance</p>
                ...
                <div class="setting-item" style="opacity: 0.6;">
                    <div class="setting-info">
                        <h4>🔍 Facial Recognition</h4>
                        <p>Facial recognition system is not set up. Contact administrator to enable this feature.</p>
        ...
        <div class="settings-card">
            ...
            <div class="settings-content">
                <div class="setting-info" style="margin-bottom: 1rem;">
                    ...
                    <p>Set specific hours when the scanner should be available for events</p>
        ...
        <div class="settings-card">
            ...
            <div class="settings-content">
                <div style="background: #f0f9ff; padding: 1.5rem; border-radius: 1rem; border-left: 4px solid #0ea5e9;">
                    <h4 style="margin: 0 0 1rem 0; color: #0c4a6e;">📋 How Scanner Settings Work</h4>
                    <ul style="margin: 0; color: #0c4a6e; line-height: 1.6;">
                        <li><strong>QR Scanner:</strong> Controls camera-based QR code scanning</li>
                        <li><strong>Manual ID Entry:</strong> Controls manual student ID input</li>
                        <li><strong>Time Schedule:</strong> Restricts scanner availability to specific hours</li>
        ...
        document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                if (!this.checked && (this.name === 'qr_scanner_enabled' || this.name === 'manual_id_enabled')) {
                    if (!confirm('Are you sure you want to disable this feature? This will prevent students from using this scanning method.')) {
                        this.checked = true;
                        return false;
                    }
                }
